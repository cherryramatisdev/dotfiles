...
require("nvim-lsp-installer").on_server_ready(function(server)
  ...
  if server.name == "tsserver" then
    opts.on_attach = function(client, bufnr)
      ...
      buf_set_keymap("n", "<leader>lr", "<cmd>lua vim.lsp.buf.rename()<CR>", map_opts)
      buf_set_keymap("n", "<leader>ls", "<cmd>lua vim.lsp.buf.signature_help()<CR>", map_opts)
      ...
      buf_set_keymap("n", "<leader>k", "<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>", map_opts)
      buf_set_keymap("n", "<C-j>", "<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>", map_opts)
      buf_set_keymap("n", "<C-k>", "<cmd>lua vim.lsp.diagnostic.goto_next()<CR>", map_opts)
      ...
      vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>lR", ":TSLspRenameFile<CR>", map_opts)
