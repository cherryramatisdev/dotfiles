...
return use("Olical/AnsiEsc", {}, "Olical/aniseed", {branch = "develop"}, "Olical/conjure", {branch = "develop", mod = "conjure"}, "Olical/vim-enmasse", {}, "wbthomason/packer.nvim", {}, "nvim-treesitter/nvim-treesitter", {mod = "treesitter", run = ":TSUpdate"}, "srcery-colors/srcery-vim", {mod = "colors"}, "hrsh7th/nvim-compe", {mod = "compe"}, "kristijanhusak/orgmode.nvim", {mod = "org"})