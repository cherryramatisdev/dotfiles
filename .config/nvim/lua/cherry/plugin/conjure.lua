local _2afile_2a = "/home/cherry/.config/nvim/fnl/cherry/plugin/conjure.fnl"
local _0_
do
  local name_0_ = "cherry.plugin.conjure"
  local module_0_
  do
...
local _2amodule_name_2a = "cherry.plugin.conjure"
