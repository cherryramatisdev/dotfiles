...
_G.packer_plugins = {
  ...
  ["colorbuddy.nvim"] = {
    loaded = true,
    path = "/home/cherry/.local/share/nvim/site/pack/packer/start/colorbuddy.nvim"
  },
  ["gruvbuddy.nvim"] = {
...
try_loadstring("\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23plugin.colorscheme\frequire\0", "config", "gruvbuddy.nvim")
